import cv2
def change_num(x):
    img = cv2.imread('/home/lqy/Data/phone/mi_6/bad_img_detection_result_15_white2/cut/Image__2018-07-09__20-49-51.bmp', 0)  # 直接读为灰度图像
    # 二值化图像
    ...
    win = cv2.namedWindow('image2', flags=0)
